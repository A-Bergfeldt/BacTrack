...
<body>
    ...
    <div class="policy-content-container">
        ...
        <div id="policy-content-2" class="policy-content">
            ...
            <p><b>You give Our Company most of the information we gather. We collect and handle data when you: </b>
            </p>
        ...
        <div id="policy-content-3" class="policy-content">
            ...
            <p> Providing Services: To track and analyze antibiotic combination therapies for better healthcare
                outcomes.</p>
        ...
        <div id="policy-content-4" class="policy-content">
            ...
            <p>Our company securely stores your data on a local computer, and the responsibility for managing this
                data
                rests with our designated administrator.</p>
            <p>Our company retains your data for a duration of four months. After this period concludes, we ensure
                complete removal by erasing it from our database.</p>
        ...
        <div id="policy-content-5" class="policy-content">
            ...
            <p> Access, Correct, or Delete Your Information: You can request access, correction, or deletion of your
                personal information by contacting us.</p>
            <p> Opt-Out of Communications: You can opt-out of receiving promotional communications from us at any
                time.
            </p>
            <p> The right to rectification: You have the right to request that Our Company amend any information you
                believe to be inaccurate. Additionally, you have the right to request Our Company to supplement any
                information you believe to be incomplete.</p>
        </div>
        ...
        <div id="policy-content-6" class="policy-content">
            ...
            <p>Session cookies: At BacTrack, we implement session cookies to elevate your browsing experience. These
                cookies are temporary and remain on your device solely for the duration of your current session.
                When
                you conclude your browsing session, please be aware that they will persist until manually deleted by
                you, rather than being automatically removed.</p>

            <h3><b>6.3. How to manage cookies</b></h3>
            <p>You have the option to configure your browser to decline cookies, and the aforementioned website
                provides
                instructions on how to delete them from your browser. It's important to note that in a few
                instances,
                disabling cookies may impact the functionality of certain features on our website.</p>
        </div>
        ...
        <div id="policy-content-7" class="policy-content">
            ...
            <p>We may update this Privacy Policy periodically to reflect changes in our practices or for legal
                compliance. You will be notified of any significant changes.</p>
            <p>If you have any questions, concerns, or requests regarding this Privacy Policy or our data practices,
                please contact us at: <a href="contactus.php">here</a></p>
        </div>
