...
<head>
  ...
  <body>
    ...
    // Select all antibiotics, synergy results, strains, and samples, then close the database connection
    ...
    // Store the antibiotics, synergy results, strains, and samples in associative arrays
